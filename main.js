...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5270992,
    DYNAMIC_BASE = 5270992,
    DYNAMICTOP_PTR = 28080;
...
var ASM_CONSTS = [function($0, $1) { Module.removeAttribute( $0, Module['UTF8ToString']($1) ); },
 function($0, $1, $2) { Module.setAttribute( $0, Module['UTF8ToString']($1), Module['UTF8ToString']($2) ); },
 function($0) { Module.nodes[$0]['asmDomRaws'] = []; },
 function($0, $1) { Module.nodes[$0]['asmDomRaws'].push(Module['UTF8ToString']($1)); },
 function($0, $1) { var key = Module['UTF8ToString']($1).replace(/^on/, ""); var elm = Module.nodes[$0]; elm.removeEventListener( key, Module.eventProxy, false ); delete elm['asmDomEvents'][key]; },
 function($0, $1) { var elm = Module.nodes[$0]; elm.asmDomVNode = $1; if (elm['asmDomEvents'] === undefined) { elm['asmDomEvents'] = {}; } },
 function($0, $1) { var key = Module['UTF8ToString']($1).replace(/^on/, ""); var elm = Module.nodes[$0]; elm.addEventListener( key, Module.eventProxy, false ); elm['asmDomEvents'][key] = Module.eventProxy; },
 function($0, $1) { return $1 === 0 ? Module.createElement( Module['UTF8ToString']($0) ) : Module.createElementNS( Module['UTF8ToString']($1), Module['UTF8ToString']($0) ); },
 function($0) { return Module.createTextNode( Module['UTF8ToString']($0) ); },
 function() { return Module.createDocumentFragment(); },
 function($0) { return Module.createComment( Module['UTF8ToString']($0) ); },
 function($0, $1) { Module.appendChild($0, $1); },
 function($0, $1, $2) { Module.insertBefore($0, $1, $2) },
 function($0) { Module.removeChild($0); },
 function($0, $1, $2) { Module.insertBefore( $0, $1, Module.nextSibling($2) ); },
 function($0, $1, $2) { Module.insertBefore($0, $1, $2); },
 function($0, $1) { Module.setNodeValue( $0, Module['UTF8ToString']($1) ); },
 function($0, $1) { var parent = Module.parentNode($1); if (parent !== 0) { Module.insertBefore( parent, $0, Module.nextSibling($1) ); Module.removeChild($1); } },
 function() { window['asmDomHelpers']['eventProxy'] = function(e) { return Module['functionCallback'](this.asmDomVNode, e.type, e) }; Module.addNode = window['asmDomHelpers']['domApi']['addNode']; Module.createElement = window['asmDomHelpers']['domApi']['createElement']; Module.createElementNS = window['asmDomHelpers']['domApi']['createElementNS']; Module.createTextNode = window['asmDomHelpers']['domApi']['createTextNode']; Module.createComment = window['asmDomHelpers']['domApi']['createComment']; Module.createDocumentFragment = window['asmDomHelpers']['domApi']['createDocumentFragment']; Module.insertBefore = window['asmDomHelpers']['domApi']['insertBefore']; Module.removeChild = window['asmDomHelpers']['domApi']['removeChild']; Module.appendChild = window['asmDomHelpers']['domApi']['appendChild']; Module.removeAttribute = window['asmDomHelpers']['domApi']['removeAttribute']; Module.setAttribute = window['asmDomHelpers']['domApi']['setAttribute']; Module.parentNode = window['asmDomHelpers']['domApi']['parentNode']; Module.nextSibling = window['asmDomHelpers']['domApi']['nextSibling']; Module.setNodeValue = window['asmDomHelpers']['domApi']['setNodeValue']; Module.nodes = window['asmDomHelpers']['nodes']; Module.eventProxy = window['asmDomHelpers']['eventProxy']; }];
...
var asmLibraryArg = {
  ...
  "__emval_strictly_equals": __emval_strictly_equals,
